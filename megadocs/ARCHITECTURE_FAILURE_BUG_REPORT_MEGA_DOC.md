# Architecture Failure Bug Report

**Generated**: 2025-09-18 22:09:53
**Source Directory**: /Users/yeogirlyun/C++/sentio_cpp
**Description**: Comprehensive analysis of position management architecture failure with all relevant source modules
...
1. [temp_bug_report/allocation_manager.cpp](#file-1)
2. [temp_bug_report/allocation_manager.hpp](#file-2)
3. [temp_bug_report/architecture.md](#file-3)
4. [temp_bug_report/audit_cli.cpp](#file-4)
5. [temp_bug_report/bug_report_architecture_failure.md](#file-5)
6. [temp_bug_report/bug_report_position_history_discrepancy.md](#file-6)
7. [temp_bug_report/eod_position_manager.cpp](#file-7)
8. [temp_bug_report/eod_position_manager.hpp](#file-8)
9. [temp_bug_report/position_coordinator.cpp](#file-9)
10. [temp_bug_report/position_coordinator.hpp](#file-10)
11. [temp_bug_report/runner.cpp](#file-11)
12. [temp_bug_report/runner.hpp](#file-12)
13. [temp_bug_report/sizer.hpp](#file-13)

---

## 📄 **FILE 1 of 13**: temp_bug_report/allocation_manager.cpp

**File Information**:
- **Path**: `temp_bug_report/allocation_manager.cpp`
...
## 📄 **FILE 2 of 13**: temp_bug_report/allocation_manager.hpp

**File Information**:
- **Path**: `temp_bug_report/allocation_manager.hpp`
...
## 📄 **FILE 3 of 13**: temp_bug_report/architecture.md

**File Information**:
- **Path**: `temp_bug_report/architecture.md`
...
## 📄 **FILE 4 of 13**: temp_bug_report/audit_cli.cpp

**File Information**:
- **Path**: `temp_bug_report/audit_cli.cpp`
...
## 📄 **FILE 5 of 13**: temp_bug_report/bug_report_architecture_failure.md

**File Information**:
- **Path**: `temp_bug_report/bug_report_architecture_failure.md`

- **Size**: 197 lines
- **Modified**: 2025-09-18 22:08:35
...
## 📄 **FILE 6 of 13**: temp_bug_report/bug_report_position_history_discrepancy.md

**File Information**:
- **Path**: `temp_bug_report/bug_report_position_history_discrepancy.md`
...
## 📄 **FILE 7 of 13**: temp_bug_report/eod_position_manager.cpp

**File Information**:
- **Path**: `temp_bug_report/eod_position_manager.cpp`
...
## 📄 **FILE 8 of 13**: temp_bug_report/eod_position_manager.hpp

**File Information**:
- **Path**: `temp_bug_report/eod_position_manager.hpp`
...
## 📄 **FILE 9 of 13**: temp_bug_report/position_coordinator.cpp

**File Information**:
- **Path**: `temp_bug_report/position_coordinator.cpp`
...
## 📄 **FILE 10 of 13**: temp_bug_report/position_coordinator.hpp

**File Information**:
- **Path**: `temp_bug_report/position_coordinator.hpp`
...
## 📄 **FILE 11 of 13**: temp_bug_report/runner.cpp

**File Information**:
- **Path**: `temp_bug_report/runner.cpp`
...
## 📄 **FILE 12 of 13**: temp_bug_report/runner.hpp

**File Information**:
- **Path**: `temp_bug_report/runner.hpp`
...
## 📄 **FILE 13 of 13**: temp_bug_report/sizer.hpp

**File Information**:
- **Path**: `temp_bug_report/sizer.hpp`
