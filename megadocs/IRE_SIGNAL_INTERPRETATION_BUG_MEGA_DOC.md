# IRE Strategy Signal Interpretation Bug Report

**Generated**: 2025-09-09 02:48:34
**Source Directory**: /Users/yeogirlyun/C++/sentio_cpp
**Description**: Bug report: IRE strategy appears to ignore actual signals and just buys at market open, sells at market close with fixed 100% capital allocation, suggesting signal processing or routing logic is broken.
...
13. [src/audit.cpp](#file-13)
14. [src/base_strategy.cpp](#file-14)
15. [src/cost_aware_gate.cpp](#file-15)
16. [src/csv_loader.cpp](#file-16)
17. [src/feature_builder.cpp](#file-17)
18. [src/feature_cache.cpp](#file-18)
19. [src/feature_engineering/feature_normalizer.cpp](#file-19)
20. [src/feature_engineering/kochi_features.cpp](#file-20)
21. [src/feature_engineering/technical_indicators.cpp](#file-21)
22. [src/feature_feeder.cpp](#file-22)
23. [src/feature_feeder_guarded.cpp](#file-23)
24. [src/feature_health.cpp](#file-24)
25. [src/kochi_runner.cpp](#file-25)
26. [src/main.cpp](#file-26)
27. [src/ml/model_registry_ts.cpp](#file-27)
28. [src/ml/ts_model.cpp](#file-28)
29. [src/optimizer.cpp](#file-29)
30. [src/pnl_accounting.cpp](#file-30)
31. [src/poly_fetch_main.cpp](#file-31)
32. [src/polygon_client.cpp](#file-32)
33. [src/polygon_ingest.cpp](#file-33)
34. [src/router.cpp](#file-34)
35. [src/rth_calendar.cpp](#file-35)
36. [src/runner.cpp](#file-36)
37. [src/sanity.cpp](#file-37)
38. [src/signal_engine.cpp](#file-38)
39. [src/signal_gate.cpp](#file-39)
40. [src/signal_pipeline.cpp](#file-40)
41. [src/signal_trace.cpp](#file-41)
42. [src/sim_data.cpp](#file-42)
43. [src/strategy/run_rule_ensemble.cpp](#file-43)
44. [src/strategy_bollinger_squeeze_breakout.cpp](#file-44)
45. [src/strategy_hybrid_ppo.cpp](#file-45)
46. [src/strategy_ire.cpp](#file-46)
47. [src/strategy_kochi_ppo.cpp](#file-47)
48. [src/strategy_market_making.cpp](#file-48)
49. [src/strategy_momentum_volume.cpp](#file-49)
50. [src/strategy_opening_range_breakout.cpp](#file-50)
51. [src/strategy_order_flow_imbalance.cpp](#file-51)
52. [src/strategy_order_flow_scalping.cpp](#file-52)
53. [src/strategy_sma_cross.cpp](#file-53)
54. [src/strategy_tfa.cpp](#file-54)
55. [src/strategy_transformer_ts.cpp](#file-55)
56. [src/strategy_vwap_reversion.cpp](#file-56)
57. [src/telemetry_logger.cpp](#file-57)
58. [src/temporal_analysis.cpp](#file-58)
59. [src/time_utils.cpp](#file-59)

---

## 📄 **FILE 1 of 59**: include/sentio/rules/adapters.hpp
...
## 📄 **FILE 2 of 59**: include/sentio/rules/bbands_squeeze_rule.hpp
...
## 📄 **FILE 3 of 59**: include/sentio/rules/diversity_weighter.hpp
...
## 📄 **FILE 4 of 59**: include/sentio/rules/integrated_rule_ensemble.hpp
...
## 📄 **FILE 5 of 59**: include/sentio/rules/irule.hpp
...
## 📄 **FILE 6 of 59**: include/sentio/rules/momentum_volume_rule.hpp
...
## 📄 **FILE 7 of 59**: include/sentio/rules/ofi_proxy_rule.hpp
...
## 📄 **FILE 8 of 59**: include/sentio/rules/online_platt_calibrator.hpp
...
## 📄 **FILE 9 of 59**: include/sentio/rules/opening_range_breakout_rule.hpp
...
## 📄 **FILE 10 of 59**: include/sentio/rules/registry.hpp
...
## 📄 **FILE 11 of 59**: include/sentio/rules/sma_cross_rule.hpp
...
## 📄 **FILE 12 of 59**: include/sentio/rules/vwap_reversion_rule.hpp
...
## 📄 **FILE 14 of 59**: src/base_strategy.cpp
...
## 📄 **FILE 15 of 59**: src/cost_aware_gate.cpp
...
## 📄 **FILE 16 of 59**: src/csv_loader.cpp
...
## 📄 **FILE 17 of 59**: src/feature_builder.cpp
...
## 📄 **FILE 18 of 59**: src/feature_cache.cpp
...
## 📄 **FILE 19 of 59**: src/feature_engineering/feature_normalizer.cpp
...
## 📄 **FILE 20 of 59**: src/feature_engineering/kochi_features.cpp
...
## 📄 **FILE 21 of 59**: src/feature_engineering/technical_indicators.cpp
...
## 📄 **FILE 22 of 59**: src/feature_feeder.cpp
...
## 📄 **FILE 23 of 59**: src/feature_feeder_guarded.cpp
...
## 📄 **FILE 24 of 59**: src/feature_health.cpp
...
## 📄 **FILE 25 of 59**: src/kochi_runner.cpp
...
## 📄 **FILE 27 of 59**: src/ml/model_registry_ts.cpp
...
## 📄 **FILE 28 of 59**: src/ml/ts_model.cpp
...
## 📄 **FILE 29 of 59**: src/optimizer.cpp
...
## 📄 **FILE 30 of 59**: src/pnl_accounting.cpp
...
## 📄 **FILE 31 of 59**: src/poly_fetch_main.cpp
...
## 📄 **FILE 32 of 59**: src/polygon_client.cpp
...
## 📄 **FILE 33 of 59**: src/polygon_ingest.cpp
...
## 📄 **FILE 35 of 59**: src/rth_calendar.cpp
...
## 📄 **FILE 36 of 59**: src/runner.cpp

**File Information**:
- **Path**: `src/runner.cpp`

- **Size**: 377 lines
- **Modified**: 2025-09-09 02:41:46
...
RunResult run_backtest(AuditRecorder& audit, const SymbolTable& ST, const std::vector<std::vector<Bar>>& series, 
    ...
    for (size_t i = warmup_bars; i < base_series.size(); ++i) {
        ...
        // **POSITION ENTRY CUTOFF**: No new positions 30 minutes before market close
        ...
        if (i > warmup_bars) {
            ...
            int current_minutes = hour_utc * 60 + minute_utc;
            int close_minutes = market_close_hour * 60;
            int minutes_to_close = close_minutes - current_minutes;
            
            if (minutes_to_close < -300) minutes_to_close += 24 * 60;
            
            // Block new positions 30 minutes before close
        ...
        // IRE now allows BUY/SELL (non-strong) to improve healthy trade frequency
        bool is_ire = (cfg.strategy_name == "IRE");
        bool allow = (sig.type != StrategySignal::Type::HOLD);
        if (allow) {
            // Log signal
            SigType sig_type = static_cast<SigType>(static_cast<int>(sig.type));
            // create a chain id per decision path (ts + idx)
            ...
            // **DAY TRADING GATE**: Block new positions near market close
            if (route_decision && !allow_new_positions) {
                route_decision = std::nullopt; // Block the trade
            }

            if (route_decision) {
                // Log route decision
                if (logging_enabled) audit.event_route_ex(bar.ts_utc_epoch, ST.get_symbol(base_symbol_id), route_decision->instrument, route_decision->target_weight, chain_id);
                ...
                if (instrument_id != -1) {
                    ...
                    if (instrument_price > 0) {
                        ...
                        if (std::abs(trade_qty * instrument_price) > 50.0) { // **FIX**: Min trade notional $50 to eliminate dust
                            // For IRE: split across base and leverage instruments 50/50 on strong signals
                            if (is_ire) {
                                bool go_long = (trade_qty > 0);
                                std::string base_inst = ST.get_symbol(base_symbol_id);
                                // Helper lambda to place order for a given instrument and target weight
                                auto place_half = [&](const std::string& inst, double tw){
                                    int sid_inst = ST.get_id(inst);
                                    if (sid_inst < 0) return;
                                    double px = pricebook.last_px[sid_inst];
                                    if (!(px > 0)) return;
                                    double target_qty_h = sizer.calculate_target_quantity(portfolio, ST, pricebook.last_px, inst, tw, series[sid_inst], cfg.sizer);
                                    double cur_qty_h = portfolio.positions[sid_inst].qty;
                                    double dq = target_qty_h - cur_qty_h;
                                    if (std::abs(dq * px) <= 50.0) return; // **FIX**: Eliminate dust trades
                                    Side sside = (dq > 0) ? Side::Buy : Side::Sell;
                                    if (logging_enabled) audit.event_order_ex(bar.ts_utc_epoch, inst, sside, std::abs(dq), 0.0, chain_id);
                                    double realized_delta = 0.0; {
                                        const auto& pos_before = portfolio.positions[sid_inst];
                                        double closing = 0.0;
                                        if (pos_before.qty > 0 && dq < 0) closing = std::min(std::abs(dq), pos_before.qty);
                                        if (pos_before.qty < 0 && dq > 0) closing = std::min(std::abs(dq), std::abs(pos_before.qty));
                                        if (closing > 0.0) {
                                            if (pos_before.qty > 0) realized_delta = (px - pos_before.avg_price) * closing;
                                            else                    realized_delta = (pos_before.avg_price - px) * closing;
                                        }
                                    }
                                    // Apply Alpaca cost model and slippage
                                    auto [fees, slippage_cost] = AlpacaCostModel::calculate_total_costs(inst, dq, px);
                                    double exec_px = (dq > 0)
                                        ? AlpacaCostModel::apply_slippage(px, AlpacaCostModel::calculate_slippage_bps(dq, px, 1000000, 0.20), true)
                                        : AlpacaCostModel::apply_slippage(px, AlpacaCostModel::calculate_slippage_bps(dq, px, 1000000, 0.20), false);
                                    apply_fill(portfolio, sid_inst, dq, exec_px);
                                    portfolio.cash -= fees; // subtract fees from cash
                                    double eq_after = equity_mark_to_market(portfolio, pricebook.last_px);
                                    double pos_after = portfolio.positions[sid_inst].qty;
                                    if (logging_enabled) audit.event_fill_ex(bar.ts_utc_epoch, inst, exec_px, std::abs(dq), fees, sside, realized_delta, eq_after, pos_after, chain_id);
                                    total_fills++;
                                };
                                // Long/Short policy for IRE:
                                //  - STRONG_BUY: split 50/50 QQQ/TQQQ
                                //  - BUY: base only (QQQ) using full target weight
                                //  - STRONG_SELL: SQQQ only if confidence >= threshold
                                //  - SELL: skip initiating shorts; trimming handled by future logic
                                using T = StrategySignal::Type;
                                if (go_long) {
                                  if (sig.type == T::STRONG_BUY) {
                                    std::string inst_base = base_inst;
                                    std::string inst_lev  = cfg.router.bull3x;
                                    double tw_half = route_decision->target_weight * 0.5;
                                    place_half(inst_base, tw_half);
                                    place_half(inst_lev,  tw_half);
                                  } else if (sig.type == T::BUY) {
                                    std::string inst_base = base_inst;
                                    double tw = route_decision->target_weight; // full to base on non-strong
                                    place_half(inst_base, tw);
                                  }
                                } else {
                                  if (sig.type == T::STRONG_SELL && sig.confidence >= cfg.router.ire_min_conf_strong_short) {
                                    std::string inst_lev = cfg.router.bear3x; // SQQQ
                                    double tw = route_decision->target_weight; // full weight to SQQQ
                                    place_half(inst_lev, tw);
                                  }
                                  // SELL (non-strong): no action to avoid PSQ and weak shorts
                                }
                            } else {
                                // Default single-instrument path
                                Side side = (trade_qty > 0) ? Side::Buy : Side::Sell;
                                if (logging_enabled) audit.event_order_ex(bar.ts_utc_epoch, route_decision->instrument, side, std::abs(trade_qty), 0.0, chain_id);

                                // realized pnl delta (simple): if closing part of position, mark realized
                                double realized_delta = 0.0;
                                {
                                ...
                                // Apply Alpaca cost model and slippage
                                auto [fees, slippage_cost] = AlpacaCostModel::calculate_total_costs(route_decision->instrument, trade_qty, instrument_price);
                                ...
                                if (logging_enabled) audit.event_fill_ex(bar.ts_utc_epoch, route_decision->instrument, exec_px, std::abs(trade_qty), fees, side,
...
## 📄 **FILE 38 of 59**: src/signal_engine.cpp
...
## 📄 **FILE 39 of 59**: src/signal_gate.cpp
...
## 📄 **FILE 40 of 59**: src/signal_pipeline.cpp
...
## 📄 **FILE 41 of 59**: src/signal_trace.cpp
...
## 📄 **FILE 42 of 59**: src/sim_data.cpp
...
## 📄 **FILE 43 of 59**: src/strategy/run_rule_ensemble.cpp
...
## 📄 **FILE 44 of 59**: src/strategy_bollinger_squeeze_breakout.cpp
...
## 📄 **FILE 45 of 59**: src/strategy_hybrid_ppo.cpp
...
## 📄 **FILE 46 of 59**: src/strategy_ire.cpp
...
## 📄 **FILE 47 of 59**: src/strategy_kochi_ppo.cpp
...
## 📄 **FILE 48 of 59**: src/strategy_market_making.cpp
...
## 📄 **FILE 49 of 59**: src/strategy_momentum_volume.cpp
...
## 📄 **FILE 50 of 59**: src/strategy_opening_range_breakout.cpp
...
## 📄 **FILE 51 of 59**: src/strategy_order_flow_imbalance.cpp
...
## 📄 **FILE 52 of 59**: src/strategy_order_flow_scalping.cpp
...
## 📄 **FILE 53 of 59**: src/strategy_sma_cross.cpp
...
## 📄 **FILE 54 of 59**: src/strategy_tfa.cpp
...
## 📄 **FILE 55 of 59**: src/strategy_transformer_ts.cpp
...
## 📄 **FILE 56 of 59**: src/strategy_vwap_reversion.cpp
...
## 📄 **FILE 57 of 59**: src/telemetry_logger.cpp
...
## 📄 **FILE 58 of 59**: src/temporal_analysis.cpp
...
## 📄 **FILE 59 of 59**: src/time_utils.cpp
