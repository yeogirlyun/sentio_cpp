# NO_SIGNALS_STRATEGIES_MEGA_DOC

**Generated**: 2025-09-05 16:08:07
**Source Directory**: /Users/yeogirlyun/C++/sentio_cpp
**Description**: Comprehensive analysis of strategies that fail to generate signals: MarketMaking, OrderFlowScalping, and VolatilityExpansion strategies with root cause analysis and proposed fixes
...
# Bug Report: Strategies Not Generating Signals

## Summary
Three trading strategies are not generating any signals during backtesting on QQQ data:
- **MarketMaking**: 0 signals emitted, 1564 dropped
- **OrderFlowScalping**: 0 signals emitted, 1562 dropped  
- **VolatilityExpansion**: 0 signals emitted, 1564 dropped

## Test Results Summary
```
Strategy                | Signals | Dropped | Fills | Return
------------------------|---------|---------|-------|--------
MarketMaking           | 0       | 1564    | 0     | 0.000%
OrderFlowScalping      | 0       | 1562    | 0     | 0.000%
VolatilityExpansion    | 0       | 1564    | 0     | 0.000%
```

## Root Cause Analysis

### 1. MarketMaking Strategy Issues

**Problem**: Strategy requires 50 bars for volume window warm-up but drops all signals due to threshold conditions.

**Key Issues**:
- **Volume Threshold Too Restrictive**: `min_volume_ratio_ = 0.05` (5% of average volume)
- **Adverse Selection Threshold**: `adverse_selection_threshold_ = 0.004` (0.4% volatility)
- **Inventory-Based Logic**: Strategy only generates signals when inventory is skewed, but inventory starts at 0

**Code Analysis**:
```cpp
// Line 71-74: Requires 50 bars warm-up
if (rolling_volume_.size() < static_cast<size_t>(params_.at("volume_window"))) {
    diag_.drop(DropReason::MIN_BARS);
    return signal;
}

// Line 83-90: Only signals when inventory is skewed
...
### 2. OrderFlowScalping Strategy Issues

**Problem**: Strategy requires 50 bars lookback period and has very restrictive threshold conditions.

**Key Issues**:
- **Lookback Period**: Requires 50 bars minimum (`lookback_period_ = 50`)
- **Imbalance Threshold**: `imbalance_threshold_ = 0.65` (65% pressure threshold)
- **State Machine Logic**: Complex state machine with confirmation requirements

**Code Analysis**:
```cpp
// Line 52-55: Requires 50 bars warm-up
if (current_index < lookback_period_) {
    diag_.drop(DropReason::MIN_BARS);
    return signal;
}

// Line 79-81: Very restrictive threshold conditions
...
### 3. VolatilityExpansion Strategy Issues

**Problem**: Strategy requires RTH (Regular Trading Hours) validation and has complex breakout conditions.

**Key Issues**:
- **RTH Requirement**: `require_rth_ = true` - only trades during market hours
- **Multiple Lookback Windows**: Requires max(20, 20, 14) = 20 bars minimum
- **Breakout Threshold**: `breakout_k_ = 0.9` - requires 90% of ATR for breakout
- **Complex State Machine**: Flat -> Long/Short -> Exit logic

**Code Analysis**:
```cpp
// Line 60-65: Requires 20 bars warm-up
...
### QQQ Data Characteristics
- **Total Bars**: 1,564 bars
- **Data Type**: RTH (Regular Trading Hours) data
- **Time Period**: Single trading day (2025-09-04)
- **Data Quality**: All bars pass RTH validation

### Signal Drop Analysis
All three strategies show similar drop patterns:
- **MIN_BARS**: Initial warm-up period drops
- **THRESHOLD**: Most signals dropped due to threshold conditions
- **SESSION**: VolatilityExpansion drops due to RTH validation

## Proposed Solutions

### 1. MarketMaking Strategy Fixes
```cpp
// Reduce volume threshold
{"min_volume_ratio", 0.01}, // From 0.05 to 0.01

// Reduce adverse selection threshold  
{"adverse_selection_threshold", 0.008}, // From 0.004 to 0.008

// Add initial inventory bias
if (market_state_.inventory == 0.0) {
    // Generate initial signal to start trading
    signal.type = StrategySignal::Type::BUY;
    signal.confidence = 0.3;
}
```

### 2. OrderFlowScalping Strategy Fixes
```cpp
// Reduce lookback period
{"lookback_period", 20.0}, // From 50 to 20

// Reduce imbalance threshold
{"imbalance_threshold", 0.55}, // From 0.65 to 0.55

// Simplify state machine logic
if (avg_pressure > imbalance_threshold_) {
    signal.type = StrategySignal::Type::BUY;
} else if (avg_pressure < (1.0 - imbalance_threshold_)) {
    signal.type = StrategySignal::Type::SELL;
}
```

### 3. VolatilityExpansion Strategy Fixes
```cpp
// Disable RTH requirement for testing
{"require_rth", 0.0}, // From 1.0 to 0.0

// Reduce breakout threshold
{"breakout_k", 0.5}, // From 0.9 to 0.5

// Reduce lookback windows
{"lookback_hh", 10.0}, // From 20 to 10
{"lookback_ll", 10.0}, // From 20 to 10
```

## Testing Recommendations

1. **Parameter Optimization**: Run parameter sweeps to find optimal thresholds
2. **Data Validation**: Test with different time periods and market conditions
3. **Threshold Analysis**: Analyze why thresholds are too restrictive
4. **State Machine Debugging**: Add debug output to understand state transitions
...
### Test Results
- QQQ backtest results showing 0 signals for all three strategies
- Signal diagnostics showing drop reasons

## Priority
**HIGH** - These strategies represent 37.5% of the total strategy portfolio and are completely non-functional.

## Status
**OPEN** - Requires parameter tuning and logic fixes to generate signals.
...
22. [include/sentio/polygon_ingest.hpp](#file-22)
23. [include/sentio/position_manager.hpp](#file-23)
24. [include/sentio/pricebook.hpp](#file-24)
25. [include/sentio/profiling.hpp](#file-25)
26. [include/sentio/replay.hpp](#file-26)
27. [include/sentio/rolling_stats.hpp](#file-27)
28. [include/sentio/router.hpp](#file-28)
29. [include/sentio/rth_calendar.hpp](#file-29)
30. [include/sentio/runner.hpp](#file-30)
...
50. [src/pnl_accounting.cpp](#file-50)
51. [src/poly_fetch_main.cpp](#file-51)
52. [src/polygon_client.cpp](#file-52)
53. [src/polygon_ingest.cpp](#file-53)
54. [src/replay.cpp](#file-54)
55. [src/router.cpp](#file-55)
56. [src/rth_calendar.cpp](#file-56)
57. [src/runner.cpp](#file-57)
58. [src/strategy_bollinger_squeeze_breakout.cpp](#file-58)
59. [src/strategy_market_making.cpp](#file-59)
60. [src/strategy_momentum_volume.cpp](#file-60)
61. [src/strategy_opening_range_breakout.cpp](#file-61)
62. [src/strategy_order_flow_imbalance.cpp](#file-62)
63. [src/strategy_order_flow_scalping.cpp](#file-63)
64. [src/strategy_volatility_expansion.cpp](#file-64)
65. [src/strategy_vwap_reversion.cpp](#file-65)
66. [src/test_rth.cpp](#file-66)
67. [src/time_utils.cpp](#file-67)
68. [src/wf.cpp](#file-68)

---

## 📄 **FILE 1 of 68**: include/sentio/all_strategies.hpp
...
## 📄 **FILE 2 of 68**: include/sentio/alpha.hpp
...
## 📄 **FILE 3 of 68**: include/sentio/audit.hpp
...
## 📄 **FILE 4 of 68**: include/sentio/base_strategy.hpp
...
## 📄 **FILE 5 of 68**: include/sentio/binio.hpp
...
## 📄 **FILE 6 of 68**: include/sentio/bo.hpp
...
## 📄 **FILE 7 of 68**: include/sentio/bollinger.hpp
...
## 📄 **FILE 8 of 68**: include/sentio/calendar_seed.hpp
...
## 📄 **FILE 9 of 68**: include/sentio/core.hpp
...
## 📄 **FILE 10 of 68**: include/sentio/cost_model.hpp
...
## 📄 **FILE 11 of 68**: include/sentio/csv_loader.hpp
...
## 📄 **FILE 12 of 68**: include/sentio/data_resolver.hpp
...
## 📄 **FILE 13 of 68**: include/sentio/day_index.hpp
...
## 📄 **FILE 14 of 68**: include/sentio/exec_types.hpp
...
## 📄 **FILE 15 of 68**: include/sentio/metrics.hpp
...
## 📄 **FILE 16 of 68**: include/sentio/of_index.hpp
...
## 📄 **FILE 17 of 68**: include/sentio/of_precompute.hpp
...
## 📄 **FILE 18 of 68**: include/sentio/optimizer.hpp
...
## 📄 **FILE 19 of 68**: include/sentio/orderflow_types.hpp
...
## 📄 **FILE 20 of 68**: include/sentio/pnl_accounting.hpp
...
## 📄 **FILE 21 of 68**: include/sentio/polygon_client.hpp
...
## 📄 **FILE 22 of 68**: include/sentio/polygon_ingest.hpp
...
## 📄 **FILE 23 of 68**: include/sentio/position_manager.hpp
...
## 📄 **FILE 24 of 68**: include/sentio/pricebook.hpp
...
## 📄 **FILE 25 of 68**: include/sentio/profiling.hpp
...
## 📄 **FILE 26 of 68**: include/sentio/replay.hpp
...
## 📄 **FILE 27 of 68**: include/sentio/rolling_stats.hpp
...
## 📄 **FILE 28 of 68**: include/sentio/router.hpp
...
## 📄 **FILE 29 of 68**: include/sentio/rth_calendar.hpp
...
## 📄 **FILE 30 of 68**: include/sentio/runner.hpp
...
## 📄 **FILE 31 of 68**: include/sentio/signal_diag.hpp
...
## 📄 **FILE 32 of 68**: include/sentio/sizer.hpp
...
## 📄 **FILE 33 of 68**: include/sentio/strategy_bollinger_squeeze_breakout.hpp
...
## 📄 **FILE 34 of 68**: include/sentio/strategy_market_making.hpp
...
## 📄 **FILE 35 of 68**: include/sentio/strategy_momentum_volume.hpp
...
## 📄 **FILE 36 of 68**: include/sentio/strategy_opening_range_breakout.hpp
...
## 📄 **FILE 37 of 68**: include/sentio/strategy_order_flow_imbalance.hpp
...
## 📄 **FILE 38 of 68**: include/sentio/strategy_order_flow_scalping.hpp
...
## 📄 **FILE 39 of 68**: include/sentio/strategy_volatility_expansion.hpp
...
## 📄 **FILE 40 of 68**: include/sentio/strategy_vwap_reversion.hpp
...
## 📄 **FILE 41 of 68**: include/sentio/symbol_table.hpp
...
## 📄 **FILE 42 of 68**: include/sentio/time_utils.hpp
...
## 📄 **FILE 43 of 68**: include/sentio/volatility_expansion.hpp
...
## 📄 **FILE 44 of 68**: include/sentio/wf.hpp
...
## 📄 **FILE 46 of 68**: src/base_strategy.cpp
...
## 📄 **FILE 47 of 68**: src/csv_loader.cpp
...
## 📄 **FILE 49 of 68**: src/optimizer.cpp
...
## 📄 **FILE 50 of 68**: src/pnl_accounting.cpp
...
## 📄 **FILE 51 of 68**: src/poly_fetch_main.cpp
...
## 📄 **FILE 52 of 68**: src/polygon_client.cpp
...
## 📄 **FILE 53 of 68**: src/polygon_ingest.cpp
...
## 📄 **FILE 56 of 68**: src/rth_calendar.cpp
...
## 📄 **FILE 58 of 68**: src/strategy_bollinger_squeeze_breakout.cpp
...
## 📄 **FILE 59 of 68**: src/strategy_market_making.cpp
...
## 📄 **FILE 60 of 68**: src/strategy_momentum_volume.cpp
...
## 📄 **FILE 61 of 68**: src/strategy_opening_range_breakout.cpp
...
## 📄 **FILE 62 of 68**: src/strategy_order_flow_imbalance.cpp
...
## 📄 **FILE 63 of 68**: src/strategy_order_flow_scalping.cpp

**File Information**:
- **Path**: `src/strategy_order_flow_scalping.cpp`

- **Size**: 120 lines
- **Modified**: 2025-09-05 15:25:39
...
## 📄 **FILE 64 of 68**: src/strategy_volatility_expansion.cpp

**File Information**:
- **Path**: `src/strategy_volatility_expansion.cpp`

- **Size**: 132 lines
- **Modified**: 2025-09-05 15:49:23
...
## 📄 **FILE 65 of 68**: src/strategy_vwap_reversion.cpp
...
## 📄 **FILE 66 of 68**: src/test_rth.cpp
...
## 📄 **FILE 67 of 68**: src/time_utils.cpp
