# RSI Strategy Zero Signals Investigation

**Generated**: 2025-09-11 12:56:26
**Source Directory**: /Users/yeogirlyun/C++/sentio_cpp
**Description**: Comprehensive analysis of RSIStrategy signal generation issues in VM test context
...
# RSI Strategy Zero Signals Bug Report

## Issue Summary
The RSIStrategy (`RSI_PROB`) is emitting 0 signals during Virtual Market (VM) tests despite generating valid signals in standalone testing scenarios.

## Bug Details

### **Severity**: HIGH
### **Impact**: Strategy unusable in production VM testing
...
### VM Test Output
```
[SIG RSI_PROB] emitted=0 dropped=0  min_bars=0 session=0 nan=0 zerovol=0 thr=0 cooldown=0 dup=0
```

### Standalone Test Output (Working)
```
Bar 14: RSI prob = 0.030303 (price = 130)
Bar 15: RSI prob = 0.030303 (price = 132)
...
Total signals generated: 36
Allocation decisions: 1
  QQQ: weight=0.939394, confidence=0.939394, reason=RSI_BULLISH
```

## Root Cause Analysis

### 1. **Signal Pipeline Investigation**
- RSIStrategy generates valid probabilities (0.03-0.97 range)
- Confidence values are high (0.94+) - well above signal gate threshold (0.05)
- Allocation decisions are properly formed

### 2. **Signal Gate Threshold**
- Default `min_conf=0.05` in `GateCfg`
- RSIStrategy confidence values (0.94+) should pass this threshold
- No signals being dropped due to threshold (`thr=0`)

### 3. **VM Test Context Differences**
- Standalone tests: Direct `calculate_probability()` calls work
- VM tests: Signals processed through full pipeline (Strategy → Router → Runner → Audit)
- Potential issue in signal processing chain

## Technical Investigation

### Signal Flow Analysis
1. **Strategy Layer**: `RSIStrategy::calculate_probability()` ✅ Working
2. **Signal Pipeline**: `SignalPipeline::process()` ❓ Unknown
3. **Signal Gate**: `SignalGate::accept()` ❓ Unknown  
4. **Router**: `Router::route_signal()` ❓ Unknown
5. **Runner**: `Runner::execute()` ❓ Unknown

### Key Files Involved
- `include/sentio/rsi_strategy.hpp` - Strategy implementation
- `src/signal_pipeline.cpp` - Signal processing pipeline
- `src/signal_gate.cpp` - Signal filtering logic
- `src/virtual_market.cpp` - VM test orchestration
- `src/runner.cpp` - Strategy execution

## Reproduction Steps

### Working Case (Standalone)
```cpp
RSIStrategy strategy;
strategy.set_params({{"rsi_period", 14}, {"epsilon", 0.001}, {"alpha", 1.0}});
strategy.apply_params();

// Generate test bars with volatility
std::vector<Bar> bars = create_test_bars(50);
...
### Failing Case (VM Test)
```bash
./build/sentio_cli vmtest RSI_PROB QQQ --days 1 --bars-per-day 50
# Result: [SIG RSI_PROB] emitted=0 dropped=0
```

## Expected Behavior
- RSIStrategy should emit signals during VM tests
- Signal count should be > 0 for volatile market data
- Confidence values should be above threshold

## Actual Behavior
- Zero signals emitted in VM test context
- All signal drop counters remain at 0
...
- **Strategy**: RSI_PROB with default parameters

## Next Steps
1. **Signal Pipeline Debugging**: Add logging to trace signal flow
2. **VM Test Integration**: Investigate how VM test calls strategy methods
3. **Signal Gate Configuration**: Verify signal gate settings in VM context
4. **Router Configuration**: Check router settings for RSI_PROB strategy

## Related Issues
- Previous Diagnostic Strategy had similar zero-signal issues
- Signal pipeline may have strategy-specific filtering logic
- VM test may be using different signal processing path than standalone tests

## Priority
**HIGH** - This prevents RSIStrategy from being used in production VM testing, which is a core requirement for strategy validation.
...
19. [include/sentio/execution/pnl_engine.hpp](#file-19)
20. [include/sentio/feature/column_projector.hpp](#file-20)
21. [include/sentio/feature/column_projector_safe.hpp](#file-21)
22. [include/sentio/feature/csv_feature_provider.hpp](#file-22)
23. [include/sentio/feature/feature_builder_guarded.hpp](#file-23)
24. [include/sentio/feature/feature_builder_ops.hpp](#file-24)
25. [include/sentio/feature/feature_feeder_guarded.hpp](#file-25)
26. [include/sentio/feature/feature_from_spec.hpp](#file-26)
27. [include/sentio/feature/feature_matrix.hpp](#file-27)
28. [include/sentio/feature/feature_provider.hpp](#file-28)
29. [include/sentio/feature/name_diff.hpp](#file-29)
30. [include/sentio/feature/ops.hpp](#file-30)
31. [include/sentio/feature/sanitize.hpp](#file-31)
32. [include/sentio/feature/standard_scaler.hpp](#file-32)
33. [include/sentio/feature_builder.hpp](#file-33)
34. [include/sentio/feature_cache.hpp](#file-34)
35. [include/sentio/feature_engineering/feature_normalizer.hpp](#file-35)
36. [include/sentio/feature_engineering/kochi_features.hpp](#file-36)
37. [include/sentio/feature_engineering/technical_indicators.hpp](#file-37)
38. [include/sentio/feature_feeder.hpp](#file-38)
39. [include/sentio/feature_health.hpp](#file-39)
40. [include/sentio/feature_utils.hpp](#file-40)
41. [include/sentio/indicators.hpp](#file-41)
42. [include/sentio/mars_data_loader.hpp](#file-42)
43. [include/sentio/metrics.hpp](#file-43)
44. [include/sentio/ml/feature_pipeline.hpp](#file-44)
45. [include/sentio/ml/feature_window.hpp](#file-45)
46. [include/sentio/ml/iml_model.hpp](#file-46)
47. [include/sentio/ml/model_registry.hpp](#file-47)
48. [include/sentio/ml/ts_model.hpp](#file-48)
49. [include/sentio/of_index.hpp](#file-49)
50. [include/sentio/of_precompute.hpp](#file-50)
51. [include/sentio/optimizer.hpp](#file-51)
52. [include/sentio/orderflow_types.hpp](#file-52)
53. [include/sentio/pnl_accounting.hpp](#file-53)
54. [include/sentio/polygon_client.hpp](#file-54)
55. [include/sentio/polygon_ingest.hpp](#file-55)
56. [include/sentio/portfolio/alpaca_fee_model.hpp](#file-56)
57. [include/sentio/portfolio/capital_manager.hpp](#file-57)
58. [include/sentio/portfolio/fee_model.hpp](#file-58)
59. [include/sentio/portfolio/portfolio_allocator.hpp](#file-59)
60. [include/sentio/portfolio/tc_slippage_model.hpp](#file-60)
61. [include/sentio/portfolio/utilization_governor.hpp](#file-61)
62. [include/sentio/position_manager.hpp](#file-62)
63. [include/sentio/pricebook.hpp](#file-63)
64. [include/sentio/profiling.hpp](#file-64)
65. [include/sentio/progress_bar.hpp](#file-65)
66. [include/sentio/property_test.hpp](#file-66)
67. [include/sentio/rolling_stats.hpp](#file-67)
68. [include/sentio/router.hpp](#file-68)
69. [include/sentio/rsi_prob.hpp](#file-69)
70. [include/sentio/rsi_strategy.hpp](#file-70)
71. [include/sentio/rth_calendar.hpp](#file-71)
72. [include/sentio/rules/adapters.hpp](#file-72)
73. [include/sentio/rules/bbands_squeeze_rule.hpp](#file-73)
74. [include/sentio/rules/diversity_weighter.hpp](#file-74)
75. [include/sentio/rules/integrated_rule_ensemble.hpp](#file-75)
76. [include/sentio/rules/irule.hpp](#file-76)
77. [include/sentio/rules/momentum_volume_rule.hpp](#file-77)
78. [include/sentio/rules/ofi_proxy_rule.hpp](#file-78)
79. [include/sentio/rules/online_platt_calibrator.hpp](#file-79)
80. [include/sentio/rules/opening_range_breakout_rule.hpp](#file-80)
81. [include/sentio/rules/registry.hpp](#file-81)
82. [include/sentio/rules/sma_cross_rule.hpp](#file-82)
83. [include/sentio/rules/vwap_reversion_rule.hpp](#file-83)
84. [include/sentio/runner.hpp](#file-84)
85. [include/sentio/sanity.hpp](#file-85)
86. [include/sentio/signal.hpp](#file-86)
87. [include/sentio/signal_diag.hpp](#file-87)
88. [include/sentio/signal_engine.hpp](#file-88)
89. [include/sentio/signal_gate.hpp](#file-89)
90. [include/sentio/signal_pipeline.hpp](#file-90)
91. [include/sentio/signal_trace.hpp](#file-91)
92. [include/sentio/sim_data.hpp](#file-92)
93. [include/sentio/sizer.hpp](#file-93)
94. [include/sentio/strategy/intraday_position_governor.hpp](#file-94)
95. [include/sentio/strategy_bollinger_squeeze_breakout.hpp](#file-95)
96. [include/sentio/strategy_hybrid_ppo.hpp](#file-96)
97. [include/sentio/strategy_ire.hpp](#file-97)
98. [include/sentio/strategy_kochi_ppo.hpp](#file-98)
99. [include/sentio/strategy_market_making.hpp](#file-99)
100. [include/sentio/strategy_momentum_volume.hpp](#file-100)
101. [include/sentio/strategy_opening_range_breakout.hpp](#file-101)
102. [include/sentio/strategy_order_flow_imbalance.hpp](#file-102)
103. [include/sentio/strategy_order_flow_scalping.hpp](#file-103)
104. [include/sentio/strategy_sma_cross.hpp](#file-104)
105. [include/sentio/strategy_tfa.hpp](#file-105)
106. [include/sentio/strategy_transformer.hpp](#file-106)
107. [include/sentio/strategy_transformer_ts.hpp](#file-107)
108. [include/sentio/strategy_utils.hpp](#file-108)
109. [include/sentio/strategy_vwap_reversion.hpp](#file-109)
110. [include/sentio/sym/leverage_registry.hpp](#file-110)
111. [include/sentio/sym/symbol_utils.hpp](#file-111)
112. [include/sentio/symbol_table.hpp](#file-112)
113. [include/sentio/telemetry_logger.hpp](#file-113)
114. [include/sentio/temporal_analysis.hpp](#file-114)
115. [include/sentio/tfa/artifacts_loader.hpp](#file-115)
116. [include/sentio/tfa/artifacts_safe.hpp](#file-116)
117. [include/sentio/tfa/feature_guard.hpp](#file-117)
118. [include/sentio/tfa/input_shim.hpp](#file-118)
119. [include/sentio/tfa/signal_pipeline.hpp](#file-119)
120. [include/sentio/tfa/tfa_seq_context.hpp](#file-120)
121. [include/sentio/time_utils.hpp](#file-121)
122. [include/sentio/torch/safe_from_blob.hpp](#file-122)
123. [include/sentio/util/bytes.hpp](#file-123)
124. [include/sentio/util/safe_matrix.hpp](#file-124)
125. [include/sentio/virtual_market.hpp](#file-125)
126. [include/sentio/wf.hpp](#file-126)
127. [src/audit.cpp](#file-127)
128. [src/base_strategy.cpp](#file-128)
129. [src/cost_aware_gate.cpp](#file-129)
130. [src/csv_loader.cpp](#file-130)
131. [src/feature_builder.cpp](#file-131)
132. [src/feature_cache.cpp](#file-132)
133. [src/feature_engineering/feature_normalizer.cpp](#file-133)
134. [src/feature_engineering/kochi_features.cpp](#file-134)
135. [src/feature_engineering/technical_indicators.cpp](#file-135)
136. [src/feature_feeder.cpp](#file-136)
137. [src/feature_feeder_guarded.cpp](#file-137)
138. [src/feature_health.cpp](#file-138)
139. [src/kochi_runner.cpp](#file-139)
140. [src/main.cpp](#file-140)
141. [src/mars_data_loader.cpp](#file-141)
142. [src/ml/model_registry_ts.cpp](#file-142)
143. [src/ml/ts_model.cpp](#file-143)
144. [src/optimizer.cpp](#file-144)
145. [src/pnl_accounting.cpp](#file-145)
146. [src/poly_fetch_main.cpp](#file-146)
147. [src/polygon_client.cpp](#file-147)
148. [src/polygon_ingest.cpp](#file-148)
149. [src/router.cpp](#file-149)
150. [src/rsi_strategy.cpp](#file-150)
151. [src/rth_calendar.cpp](#file-151)
152. [src/runner.cpp](#file-152)
153. [src/sanity.cpp](#file-153)
154. [src/signal_engine.cpp](#file-154)
155. [src/signal_gate.cpp](#file-155)
156. [src/signal_pipeline.cpp](#file-156)
157. [src/signal_trace.cpp](#file-157)
158. [src/sim_data.cpp](#file-158)
159. [src/strategy/run_rule_ensemble.cpp](#file-159)
160. [src/strategy_bollinger_squeeze_breakout.cpp](#file-160)
161. [src/strategy_hybrid_ppo.cpp](#file-161)
162. [src/strategy_initialization.cpp](#file-162)
163. [src/strategy_ire.cpp](#file-163)
164. [src/strategy_kochi_ppo.cpp](#file-164)
165. [src/strategy_market_making.cpp](#file-165)
166. [src/strategy_momentum_volume.cpp](#file-166)
167. [src/strategy_opening_range_breakout.cpp](#file-167)
168. [src/strategy_order_flow_imbalance.cpp](#file-168)
169. [src/strategy_order_flow_scalping.cpp](#file-169)
170. [src/strategy_sma_cross.cpp](#file-170)
171. [src/strategy_tfa.cpp](#file-171)
172. [src/strategy_transformer_ts.cpp](#file-172)
173. [src/strategy_vwap_reversion.cpp](#file-173)
174. [src/telemetry_logger.cpp](#file-174)
175. [src/temporal_analysis.cpp](#file-175)
176. [src/time_utils.cpp](#file-176)
177. [src/virtual_market.cpp](#file-177)

---

## 📄 **FILE 1 of 177**: include/sentio/all_strategies.hpp
...
## 📄 **FILE 2 of 177**: include/sentio/alpha.hpp
...
## 📄 **FILE 3 of 177**: include/sentio/alpha/sota_linear_policy.hpp
...
## 📄 **FILE 4 of 177**: include/sentio/audit.hpp
...
## 📄 **FILE 5 of 177**: include/sentio/base_strategy.hpp
...
## 📄 **FILE 6 of 177**: include/sentio/binio.hpp
...
## 📄 **FILE 7 of 177**: include/sentio/bo.hpp
...
## 📄 **FILE 8 of 177**: include/sentio/bollinger.hpp
...
## 📄 **FILE 9 of 177**: include/sentio/calendar_seed.hpp
...
## 📄 **FILE 10 of 177**: include/sentio/core.hpp
...
## 📄 **FILE 11 of 177**: include/sentio/core/bar.hpp
...
## 📄 **FILE 12 of 177**: include/sentio/cost_aware_gate.hpp
...
## 📄 **FILE 13 of 177**: include/sentio/cost_model.hpp
...
## 📄 **FILE 14 of 177**: include/sentio/csv_loader.hpp
...
## 📄 **FILE 15 of 177**: include/sentio/data_resolver.hpp
...
## 📄 **FILE 16 of 177**: include/sentio/day_index.hpp
...
## 📄 **FILE 17 of 177**: include/sentio/exec/asof_index.hpp
...
## 📄 **FILE 18 of 177**: include/sentio/exec_types.hpp
...
## 📄 **FILE 19 of 177**: include/sentio/execution/pnl_engine.hpp
...
## 📄 **FILE 20 of 177**: include/sentio/feature/column_projector.hpp
...
## 📄 **FILE 21 of 177**: include/sentio/feature/column_projector_safe.hpp
...
## 📄 **FILE 22 of 177**: include/sentio/feature/csv_feature_provider.hpp
...
## 📄 **FILE 23 of 177**: include/sentio/feature/feature_builder_guarded.hpp
...
## 📄 **FILE 24 of 177**: include/sentio/feature/feature_builder_ops.hpp
...
## 📄 **FILE 25 of 177**: include/sentio/feature/feature_feeder_guarded.hpp
...
## 📄 **FILE 26 of 177**: include/sentio/feature/feature_from_spec.hpp
...
## 📄 **FILE 27 of 177**: include/sentio/feature/feature_matrix.hpp
...
## 📄 **FILE 28 of 177**: include/sentio/feature/feature_provider.hpp
...
## 📄 **FILE 29 of 177**: include/sentio/feature/name_diff.hpp
...
## 📄 **FILE 30 of 177**: include/sentio/feature/ops.hpp
...
## 📄 **FILE 31 of 177**: include/sentio/feature/sanitize.hpp
...
## 📄 **FILE 32 of 177**: include/sentio/feature/standard_scaler.hpp
...
## 📄 **FILE 33 of 177**: include/sentio/feature_builder.hpp
...
## 📄 **FILE 34 of 177**: include/sentio/feature_cache.hpp
...
## 📄 **FILE 35 of 177**: include/sentio/feature_engineering/feature_normalizer.hpp
...
## 📄 **FILE 36 of 177**: include/sentio/feature_engineering/kochi_features.hpp
...
## 📄 **FILE 37 of 177**: include/sentio/feature_engineering/technical_indicators.hpp
...
## 📄 **FILE 38 of 177**: include/sentio/feature_feeder.hpp
...
## 📄 **FILE 39 of 177**: include/sentio/feature_health.hpp
...
## 📄 **FILE 40 of 177**: include/sentio/feature_utils.hpp
...
## 📄 **FILE 41 of 177**: include/sentio/indicators.hpp
...
## 📄 **FILE 42 of 177**: include/sentio/mars_data_loader.hpp
...
## 📄 **FILE 43 of 177**: include/sentio/metrics.hpp
...
## 📄 **FILE 44 of 177**: include/sentio/ml/feature_pipeline.hpp
...
## 📄 **FILE 45 of 177**: include/sentio/ml/feature_window.hpp
...
## 📄 **FILE 46 of 177**: include/sentio/ml/iml_model.hpp
...
## 📄 **FILE 47 of 177**: include/sentio/ml/model_registry.hpp
...
## 📄 **FILE 48 of 177**: include/sentio/ml/ts_model.hpp
...
## 📄 **FILE 49 of 177**: include/sentio/of_index.hpp
...
## 📄 **FILE 50 of 177**: include/sentio/of_precompute.hpp
...
## 📄 **FILE 51 of 177**: include/sentio/optimizer.hpp
...
## 📄 **FILE 52 of 177**: include/sentio/orderflow_types.hpp
...
## 📄 **FILE 53 of 177**: include/sentio/pnl_accounting.hpp
...
## 📄 **FILE 54 of 177**: include/sentio/polygon_client.hpp
...
## 📄 **FILE 55 of 177**: include/sentio/polygon_ingest.hpp
...
## 📄 **FILE 56 of 177**: include/sentio/portfolio/alpaca_fee_model.hpp
...
## 📄 **FILE 57 of 177**: include/sentio/portfolio/capital_manager.hpp
...
## 📄 **FILE 58 of 177**: include/sentio/portfolio/fee_model.hpp
...
## 📄 **FILE 59 of 177**: include/sentio/portfolio/portfolio_allocator.hpp
...
## 📄 **FILE 60 of 177**: include/sentio/portfolio/tc_slippage_model.hpp
...
## 📄 **FILE 61 of 177**: include/sentio/portfolio/utilization_governor.hpp
...
## 📄 **FILE 62 of 177**: include/sentio/position_manager.hpp
...
## 📄 **FILE 63 of 177**: include/sentio/pricebook.hpp
...
## 📄 **FILE 64 of 177**: include/sentio/profiling.hpp
...
## 📄 **FILE 65 of 177**: include/sentio/progress_bar.hpp
...
## 📄 **FILE 66 of 177**: include/sentio/property_test.hpp
...
## 📄 **FILE 67 of 177**: include/sentio/rolling_stats.hpp
...
## 📄 **FILE 68 of 177**: include/sentio/router.hpp
...
## 📄 **FILE 69 of 177**: include/sentio/rsi_prob.hpp
...
## 📄 **FILE 70 of 177**: include/sentio/rsi_strategy.hpp

**File Information**:
- **Path**: `include/sentio/rsi_strategy.hpp`

- **Size**: 188 lines
- **Modified**: 2025-09-11 12:55:18
...
public:
    ...
    double calculate_probability(const std::vector<Bar>& bars, int current_index) override {
        ...
        return rsi_to_prob_tuned(rsi, alpha_);
    }
...
## 📄 **FILE 71 of 177**: include/sentio/rth_calendar.hpp
...
## 📄 **FILE 72 of 177**: include/sentio/rules/adapters.hpp
...
## 📄 **FILE 73 of 177**: include/sentio/rules/bbands_squeeze_rule.hpp
...
## 📄 **FILE 74 of 177**: include/sentio/rules/diversity_weighter.hpp
...
## 📄 **FILE 75 of 177**: include/sentio/rules/integrated_rule_ensemble.hpp
...
## 📄 **FILE 76 of 177**: include/sentio/rules/irule.hpp
...
## 📄 **FILE 77 of 177**: include/sentio/rules/momentum_volume_rule.hpp
...
## 📄 **FILE 78 of 177**: include/sentio/rules/ofi_proxy_rule.hpp
...
## 📄 **FILE 79 of 177**: include/sentio/rules/online_platt_calibrator.hpp
...
## 📄 **FILE 80 of 177**: include/sentio/rules/opening_range_breakout_rule.hpp
...
## 📄 **FILE 81 of 177**: include/sentio/rules/registry.hpp
...
## 📄 **FILE 82 of 177**: include/sentio/rules/sma_cross_rule.hpp
...
## 📄 **FILE 83 of 177**: include/sentio/rules/vwap_reversion_rule.hpp
...
## 📄 **FILE 84 of 177**: include/sentio/runner.hpp
...
## 📄 **FILE 85 of 177**: include/sentio/sanity.hpp
...
## 📄 **FILE 86 of 177**: include/sentio/signal.hpp
...
## 📄 **FILE 87 of 177**: include/sentio/signal_diag.hpp
...
## 📄 **FILE 88 of 177**: include/sentio/signal_engine.hpp
...
## 📄 **FILE 89 of 177**: include/sentio/signal_gate.hpp
...
## 📄 **FILE 90 of 177**: include/sentio/signal_pipeline.hpp
...
## 📄 **FILE 91 of 177**: include/sentio/signal_trace.hpp
...
## 📄 **FILE 92 of 177**: include/sentio/sim_data.hpp
...
## 📄 **FILE 93 of 177**: include/sentio/sizer.hpp
...
## 📄 **FILE 94 of 177**: include/sentio/strategy/intraday_position_governor.hpp
...
## 📄 **FILE 95 of 177**: include/sentio/strategy_bollinger_squeeze_breakout.hpp
...
## 📄 **FILE 96 of 177**: include/sentio/strategy_hybrid_ppo.hpp
...
## 📄 **FILE 97 of 177**: include/sentio/strategy_ire.hpp
...
## 📄 **FILE 98 of 177**: include/sentio/strategy_kochi_ppo.hpp
...
## 📄 **FILE 99 of 177**: include/sentio/strategy_market_making.hpp
...
## 📄 **FILE 100 of 177**: include/sentio/strategy_momentum_volume.hpp
...
## 📄 **FILE 101 of 177**: include/sentio/strategy_opening_range_breakout.hpp
...
## 📄 **FILE 102 of 177**: include/sentio/strategy_order_flow_imbalance.hpp
...
## 📄 **FILE 103 of 177**: include/sentio/strategy_order_flow_scalping.hpp
...
## 📄 **FILE 104 of 177**: include/sentio/strategy_sma_cross.hpp
...
## 📄 **FILE 105 of 177**: include/sentio/strategy_tfa.hpp
...
## 📄 **FILE 106 of 177**: include/sentio/strategy_transformer.hpp
...
## 📄 **FILE 107 of 177**: include/sentio/strategy_transformer_ts.hpp
...
## 📄 **FILE 108 of 177**: include/sentio/strategy_utils.hpp
...
## 📄 **FILE 109 of 177**: include/sentio/strategy_vwap_reversion.hpp
...
## 📄 **FILE 110 of 177**: include/sentio/sym/leverage_registry.hpp
...
## 📄 **FILE 111 of 177**: include/sentio/sym/symbol_utils.hpp
...
## 📄 **FILE 112 of 177**: include/sentio/symbol_table.hpp
...
## 📄 **FILE 113 of 177**: include/sentio/telemetry_logger.hpp
...
## 📄 **FILE 114 of 177**: include/sentio/temporal_analysis.hpp
...
## 📄 **FILE 115 of 177**: include/sentio/tfa/artifacts_loader.hpp
...
## 📄 **FILE 116 of 177**: include/sentio/tfa/artifacts_safe.hpp
...
## 📄 **FILE 117 of 177**: include/sentio/tfa/feature_guard.hpp
...
## 📄 **FILE 118 of 177**: include/sentio/tfa/input_shim.hpp
...
## 📄 **FILE 119 of 177**: include/sentio/tfa/signal_pipeline.hpp
...
## 📄 **FILE 120 of 177**: include/sentio/tfa/tfa_seq_context.hpp
...
## 📄 **FILE 121 of 177**: include/sentio/time_utils.hpp
...
## 📄 **FILE 122 of 177**: include/sentio/torch/safe_from_blob.hpp
...
## 📄 **FILE 123 of 177**: include/sentio/util/bytes.hpp
...
## 📄 **FILE 124 of 177**: include/sentio/util/safe_matrix.hpp
...
## 📄 **FILE 125 of 177**: include/sentio/virtual_market.hpp
...
## 📄 **FILE 126 of 177**: include/sentio/wf.hpp
...
## 📄 **FILE 127 of 177**: src/audit.cpp

**File Information**:
- **Path**: `src/audit.cpp`

- **Size**: 289 lines
- **Modified**: 2025-09-11 11:54:39
...
## 📄 **FILE 128 of 177**: src/base_strategy.cpp
...
## 📄 **FILE 129 of 177**: src/cost_aware_gate.cpp
...
## 📄 **FILE 130 of 177**: src/csv_loader.cpp
...
## 📄 **FILE 131 of 177**: src/feature_builder.cpp
...
## 📄 **FILE 132 of 177**: src/feature_cache.cpp
...
## 📄 **FILE 133 of 177**: src/feature_engineering/feature_normalizer.cpp
...
## 📄 **FILE 134 of 177**: src/feature_engineering/kochi_features.cpp
...
## 📄 **FILE 135 of 177**: src/feature_engineering/technical_indicators.cpp
...
## 📄 **FILE 136 of 177**: src/feature_feeder.cpp
...
## 📄 **FILE 137 of 177**: src/feature_feeder_guarded.cpp
...
## 📄 **FILE 138 of 177**: src/feature_health.cpp
...
## 📄 **FILE 139 of 177**: src/kochi_runner.cpp
...
## 📄 **FILE 141 of 177**: src/mars_data_loader.cpp
...
## 📄 **FILE 142 of 177**: src/ml/model_registry_ts.cpp
...
## 📄 **FILE 143 of 177**: src/ml/ts_model.cpp
...
## 📄 **FILE 144 of 177**: src/optimizer.cpp
...
## 📄 **FILE 145 of 177**: src/pnl_accounting.cpp
...
## 📄 **FILE 146 of 177**: src/poly_fetch_main.cpp
...
## 📄 **FILE 147 of 177**: src/polygon_client.cpp
...
## 📄 **FILE 148 of 177**: src/polygon_ingest.cpp
...
## 📄 **FILE 149 of 177**: src/router.cpp
...
## 📄 **FILE 150 of 177**: src/rsi_strategy.cpp
...
## 📄 **FILE 151 of 177**: src/rth_calendar.cpp
...
## 📄 **FILE 152 of 177**: src/runner.cpp
...
## 📄 **FILE 153 of 177**: src/sanity.cpp
...
## 📄 **FILE 154 of 177**: src/signal_engine.cpp
...
## 📄 **FILE 155 of 177**: src/signal_gate.cpp
...
## 📄 **FILE 156 of 177**: src/signal_pipeline.cpp
...
## 📄 **FILE 157 of 177**: src/signal_trace.cpp
...
## 📄 **FILE 158 of 177**: src/sim_data.cpp
...
## 📄 **FILE 159 of 177**: src/strategy/run_rule_ensemble.cpp
...
## 📄 **FILE 160 of 177**: src/strategy_bollinger_squeeze_breakout.cpp
...
## 📄 **FILE 161 of 177**: src/strategy_hybrid_ppo.cpp
...
## 📄 **FILE 162 of 177**: src/strategy_initialization.cpp
...
## 📄 **FILE 163 of 177**: src/strategy_ire.cpp

**File Information**:
- **Path**: `src/strategy_ire.cpp`

- **Size**: 389 lines
- **Modified**: 2025-09-11 02:38:23
...
## 📄 **FILE 164 of 177**: src/strategy_kochi_ppo.cpp
...
## 📄 **FILE 165 of 177**: src/strategy_market_making.cpp
...
## 📄 **FILE 166 of 177**: src/strategy_momentum_volume.cpp
...
## 📄 **FILE 167 of 177**: src/strategy_opening_range_breakout.cpp
...
## 📄 **FILE 168 of 177**: src/strategy_order_flow_imbalance.cpp
...
## 📄 **FILE 169 of 177**: src/strategy_order_flow_scalping.cpp
...
## 📄 **FILE 170 of 177**: src/strategy_sma_cross.cpp
...
## 📄 **FILE 171 of 177**: src/strategy_tfa.cpp
...
## 📄 **FILE 172 of 177**: src/strategy_transformer_ts.cpp
...
## 📄 **FILE 173 of 177**: src/strategy_vwap_reversion.cpp
...
## 📄 **FILE 174 of 177**: src/telemetry_logger.cpp
...
## 📄 **FILE 175 of 177**: src/temporal_analysis.cpp
...
## 📄 **FILE 176 of 177**: src/time_utils.cpp
...
## 📄 **FILE 177 of 177**: src/virtual_market.cpp
