# RTH Validation Regression - Final Analysis with Complete Source Code

**Generated**: 2025-09-05 15:01:17
**Source Directory**: /Users/yeogirlyun/C++/sentio_cpp
**Description**: Comprehensive analysis of RTH validation regression with all source code and debugging information
...
69. [tools/create_mega_document.py](#file-69)
70. [tools/data_downloader.py](#file-70)

---

## 📄 **FILE 1 of 70**: include/sentio/all_strategies.hpp
...
## 📄 **FILE 2 of 70**: include/sentio/alpha.hpp
...
## 📄 **FILE 3 of 70**: include/sentio/audit.hpp
...
## 📄 **FILE 4 of 70**: include/sentio/base_strategy.hpp
...
## 📄 **FILE 5 of 70**: include/sentio/binio.hpp
...
## 📄 **FILE 6 of 70**: include/sentio/bo.hpp
...
## 📄 **FILE 7 of 70**: include/sentio/bollinger.hpp
...
## 📄 **FILE 8 of 70**: include/sentio/calendar_seed.hpp
...
## 📄 **FILE 9 of 70**: include/sentio/core.hpp
...
## 📄 **FILE 10 of 70**: include/sentio/cost_model.hpp
...
## 📄 **FILE 11 of 70**: include/sentio/csv_loader.hpp
...
## 📄 **FILE 12 of 70**: include/sentio/data_resolver.hpp
...
## 📄 **FILE 13 of 70**: include/sentio/day_index.hpp
...
## 📄 **FILE 14 of 70**: include/sentio/exec_types.hpp
...
## 📄 **FILE 15 of 70**: include/sentio/metrics.hpp
...
## 📄 **FILE 16 of 70**: include/sentio/of_index.hpp
...
## 📄 **FILE 17 of 70**: include/sentio/of_precompute.hpp
...
## 📄 **FILE 18 of 70**: include/sentio/optimizer.hpp
...
## 📄 **FILE 19 of 70**: include/sentio/orderflow_types.hpp
...
## 📄 **FILE 20 of 70**: include/sentio/pnl_accounting.hpp

**File Information**:
- **Path**: `include/sentio/pnl_accounting.hpp`

- **Size**: 28 lines
- **Modified**: 2025-09-05 14:57:02
...
## 📄 **FILE 21 of 70**: include/sentio/polygon_client.hpp
...
## 📄 **FILE 22 of 70**: include/sentio/position_manager.hpp
...
## 📄 **FILE 23 of 70**: include/sentio/pricebook.hpp
...
## 📄 **FILE 24 of 70**: include/sentio/profiling.hpp
...
## 📄 **FILE 25 of 70**: include/sentio/replay.hpp
...
## 📄 **FILE 26 of 70**: include/sentio/rolling_stats.hpp
...
## 📄 **FILE 27 of 70**: include/sentio/router.hpp

**File Information**:
- **Path**: `include/sentio/router.hpp`

- **Size**: 25 lines
- **Modified**: 2025-09-05 14:54:33
...
## 📄 **FILE 28 of 70**: include/sentio/rth_calendar.hpp
...
## 📄 **FILE 29 of 70**: include/sentio/runner.hpp
...
## 📄 **FILE 30 of 70**: include/sentio/session_nyt.hpp
...
## 📄 **FILE 31 of 70**: include/sentio/signal_diag.hpp
...
## 📄 **FILE 32 of 70**: include/sentio/sizer.hpp
...
## 📄 **FILE 33 of 70**: include/sentio/strategy_bollinger_squeeze_breakout.hpp
...
## 📄 **FILE 34 of 70**: include/sentio/strategy_market_making.hpp
...
## 📄 **FILE 35 of 70**: include/sentio/strategy_momentum_volume.hpp
...
## 📄 **FILE 36 of 70**: include/sentio/strategy_opening_range_breakout.hpp
...
## 📄 **FILE 37 of 70**: include/sentio/strategy_order_flow_imbalance.hpp
...
## 📄 **FILE 38 of 70**: include/sentio/strategy_order_flow_scalping.hpp
...
## 📄 **FILE 39 of 70**: include/sentio/strategy_volatility_expansion.hpp
...
## 📄 **FILE 40 of 70**: include/sentio/strategy_vwap_reversion.hpp
...
## 📄 **FILE 41 of 70**: include/sentio/symbol_table.hpp
...
## 📄 **FILE 42 of 70**: include/sentio/time_utils.hpp
...
## 📄 **FILE 43 of 70**: include/sentio/volatility_expansion.hpp
...
## 📄 **FILE 44 of 70**: include/sentio/wf.hpp
...
## 📄 **FILE 46 of 70**: src/base_strategy.cpp
...
## 📄 **FILE 47 of 70**: src/csv_loader.cpp
...
## 📄 **FILE 49 of 70**: src/optimizer.cpp
...
## 📄 **FILE 50 of 70**: src/pnl_accounting.cpp
...
## 📄 **FILE 51 of 70**: src/poly_fetch_main.cpp
...
## 📄 **FILE 52 of 70**: src/polygon_client.cpp
...
## 📄 **FILE 53 of 70**: src/polygon_ingest.cpp
...
#include "sentio/router.hpp"           // RouteDecision, RouterCfg, route function
#include "sentio/base_strategy.hpp"    // StrategySignal, SignalType
...
// Map a base symbol + side into a concrete tradable instrument.
// You can extend this table per your universe.
static inline std::string map_instrument(const std::string& base, bool is_long, bool strong) {
    // QQQ family
    if (base == "QQQ") {
        if (is_long) return strong ? "TQQQ" : "QQQ";     // 3x bull vs 1x
        return strong ? "SQQQ" : "PSQ";                  // 3x bear vs 1x inverse
    }
    // TSLA family
    if (base == "TSLA") {
        if (is_long) return "TSLA";                      // cash (no common bull ETF)
        return "TSLQ";                                   // short TSLA ETF
    }
    // Default: fall back to base
    return base;
}

// Turn a StrategySignal into (direction, "strength")
// strength is |confidence| in [0, 1] (clamped); direction +1 / -1 / 0
static inline int signal_dir(const StrategySignal& s) {
    switch (s.signal) {
        case SignalType::BUY:         return +1;
        case SignalType::STRONG_BUY:  return +1;
        case SignalType::SELL:        return -1;
        case SignalType::STRONG_SELL: return -1;
        default:                      return  0;
    }
}
static inline bool is_strong(const StrategySignal& s) {
    return s.signal == SignalType::STRONG_BUY || s.signal == SignalType::STRONG_SELL;
}
static inline double strength01(const StrategySignal& s) {
    // confidence already looks like 0..1 in your doc; clamp just in case
    return clamp(std::abs(s.confidence), 0.0, 1.0);
}

// --------- The missing function ---------------------------------------

std::optional<RouteDecision>
route(const StrategySignal& s, const RouterCfg& cfg, const std::string& base_symbol)
{
    // 0) Filter out weak / no-op signals
    const int dir = signal_dir(s);
    if (dir == 0) return std::nullopt;

    const double z = strength01(s);
    if (z < cfg.min_signal_strength) return std::nullopt;

    // 1) Choose concrete instrument
    const bool go_long = (dir > 0);
    const bool strong  = is_strong(s) || (z >= 0.90); // treat very high confidence as "strong"
    const std::string instrument = map_instrument(base_symbol, go_long, strong);

    // 2) Convert signal strength into a target portfolio weight
    //    weight in [-max_position_pct, +max_position_pct]
    const double raw = (dir > 0 ? +1.0 : -1.0) * (z * cfg.signal_multiplier);
    const double weight = clamp(raw, -cfg.max_position_pct, +cfg.max_position_pct);

    // 3) Session checks (if you keep them here). If you already do RTH gating upstream,
    //    you can delete this block. Left as a simple hook for now:
    // if (cfg.require_rth) {
    //   // You could check a timestamp from s.metadata["ts_utc_epoch"] if provided
    //   // and call pass_session_filter(cfg.require_rth, ts). Skipped here to avoid
    //   // hidden coupling; rely on your ingest to enforce RTH.
    // }

    return RouteDecision{instrument, weight};
}

} // namespace sentio
```

## 📄 **FILE 56 of 70**: src/rth_calendar.cpp
...
## 📄 **FILE 58 of 70**: src/strategy_bollinger_squeeze_breakout.cpp
...
## 📄 **FILE 59 of 70**: src/strategy_market_making.cpp
...
## 📄 **FILE 60 of 70**: src/strategy_momentum_volume.cpp
...
## 📄 **FILE 61 of 70**: src/strategy_opening_range_breakout.cpp
...
## 📄 **FILE 62 of 70**: src/strategy_order_flow_imbalance.cpp
...
## 📄 **FILE 63 of 70**: src/strategy_order_flow_scalping.cpp
...
## 📄 **FILE 64 of 70**: src/strategy_volatility_expansion.cpp
...
## 📄 **FILE 65 of 70**: src/strategy_vwap_reversion.cpp
...
## 📄 **FILE 66 of 70**: src/test_rth.cpp
...
## 📄 **FILE 67 of 70**: src/time_utils.cpp
...
## 📄 **FILE 69 of 70**: tools/create_mega_document.py
...
## 📄 **FILE 70 of 70**: tools/data_downloader.py
