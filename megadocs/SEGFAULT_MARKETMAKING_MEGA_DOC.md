# Segmentation Fault in MarketMaking Strategy - Complete Source Code

**Generated**: 2025-09-05 09:54:30
**Source Directory**: /Users/yeogirlyun/C++/sentio_cpp
**Description**: Comprehensive bug report and complete source code for the MarketMaking strategy segmentation fault issue
...
27. [include/sentio/runner.hpp](#file-27)
28. [include/sentio/session_nyt.hpp](#file-28)
29. [include/sentio/signal_diag.hpp](#file-29)
30. [include/sentio/sizer.hpp](#file-30)
31. [include/sentio/strategy_bollinger_squeeze_breakout.hpp](#file-31)
32. [include/sentio/strategy_market_making.hpp](#file-32)
33. [include/sentio/strategy_momentum_volume.hpp](#file-33)
34. [include/sentio/strategy_opening_range_breakout.hpp](#file-34)
35. [include/sentio/strategy_order_flow_imbalance.hpp](#file-35)
36. [include/sentio/strategy_order_flow_scalping.hpp](#file-36)
37. [include/sentio/strategy_volatility_expansion.hpp](#file-37)
38. [include/sentio/strategy_vwap_reversion.hpp](#file-38)
39. [include/sentio/symbol_table.hpp](#file-39)
40. [include/sentio/volatility_expansion.hpp](#file-40)
41. [include/sentio/wf.hpp](#file-41)
42. [src/audit.cpp](#file-42)
43. [src/base_strategy.cpp](#file-43)
44. [src/csv_loader.cpp](#file-44)
45. [src/main.cpp](#file-45)
46. [src/optimizer.cpp](#file-46)
47. [src/poly_fetch_main.cpp](#file-47)
48. [src/polygon_client.cpp](#file-48)
49. [src/replay.cpp](#file-49)
50. [src/router.cpp](#file-50)
51. [src/runner.cpp](#file-51)
52. [src/strategy_bollinger_squeeze_breakout.cpp](#file-52)
53. [src/strategy_market_making.cpp](#file-53)
54. [src/strategy_momentum_volume.cpp](#file-54)
55. [src/strategy_opening_range_breakout.cpp](#file-55)
56. [src/strategy_order_flow_imbalance.cpp](#file-56)
57. [src/strategy_order_flow_scalping.cpp](#file-57)
58. [src/strategy_volatility_expansion.cpp](#file-58)
59. [src/strategy_vwap_reversion.cpp](#file-59)
60. [src/wf.cpp](#file-60)

---

## 📄 **FILE 1 of 60**: include/sentio/all_strategies.hpp
...
## 📄 **FILE 2 of 60**: include/sentio/alpha.hpp
...
## 📄 **FILE 3 of 60**: include/sentio/audit.hpp
...
## 📄 **FILE 4 of 60**: include/sentio/base_strategy.hpp
...
## 📄 **FILE 5 of 60**: include/sentio/binio.hpp
...
## 📄 **FILE 6 of 60**: include/sentio/bo.hpp
...
## 📄 **FILE 7 of 60**: include/sentio/bollinger.hpp
...
## 📄 **FILE 8 of 60**: include/sentio/core.hpp
...
## 📄 **FILE 9 of 60**: include/sentio/cost_model.hpp
...
## 📄 **FILE 10 of 60**: include/sentio/csv_loader.hpp
...
## 📄 **FILE 11 of 60**: include/sentio/data_resolver.hpp
...
## 📄 **FILE 12 of 60**: include/sentio/day_index.hpp
...
## 📄 **FILE 13 of 60**: include/sentio/metrics.hpp
...
## 📄 **FILE 14 of 60**: include/sentio/of_index.hpp
...
## 📄 **FILE 15 of 60**: include/sentio/of_precompute.hpp
...
## 📄 **FILE 16 of 60**: include/sentio/optimizer.hpp
...
## 📄 **FILE 17 of 60**: include/sentio/orderflow_types.hpp
...
## 📄 **FILE 18 of 60**: include/sentio/polygon_client.hpp
...
## 📄 **FILE 19 of 60**: include/sentio/position_manager.hpp
...
## 📄 **FILE 20 of 60**: include/sentio/pricebook.hpp
...
## 📄 **FILE 21 of 60**: include/sentio/profiling.hpp
...
## 📄 **FILE 22 of 60**: include/sentio/replay.hpp
...
## 📄 **FILE 23 of 60**: include/sentio/rolling.hpp
...
## 📄 **FILE 24 of 60**: include/sentio/rolling_mean.hpp
...
## 📄 **FILE 25 of 60**: include/sentio/rolling_of.hpp
...
## 📄 **FILE 27 of 60**: include/sentio/runner.hpp
...
## 📄 **FILE 28 of 60**: include/sentio/session_nyt.hpp
...
## 📄 **FILE 29 of 60**: include/sentio/signal_diag.hpp
...
## 📄 **FILE 30 of 60**: include/sentio/sizer.hpp
...
## 📄 **FILE 31 of 60**: include/sentio/strategy_bollinger_squeeze_breakout.hpp
...
## 📄 **FILE 32 of 60**: include/sentio/strategy_market_making.hpp
...
## 📄 **FILE 33 of 60**: include/sentio/strategy_momentum_volume.hpp
...
## 📄 **FILE 34 of 60**: include/sentio/strategy_opening_range_breakout.hpp
...
## 📄 **FILE 35 of 60**: include/sentio/strategy_order_flow_imbalance.hpp
...
## 📄 **FILE 36 of 60**: include/sentio/strategy_order_flow_scalping.hpp
...
## 📄 **FILE 37 of 60**: include/sentio/strategy_volatility_expansion.hpp
...
## 📄 **FILE 38 of 60**: include/sentio/strategy_vwap_reversion.hpp
...
## 📄 **FILE 39 of 60**: include/sentio/symbol_table.hpp
...
## 📄 **FILE 40 of 60**: include/sentio/volatility_expansion.hpp
...
## 📄 **FILE 41 of 60**: include/sentio/wf.hpp
...
## 📄 **FILE 43 of 60**: src/base_strategy.cpp
...
## 📄 **FILE 44 of 60**: src/csv_loader.cpp
...
## 📄 **FILE 46 of 60**: src/optimizer.cpp
...
## 📄 **FILE 47 of 60**: src/poly_fetch_main.cpp
...
## 📄 **FILE 48 of 60**: src/polygon_client.cpp
...
## 📄 **FILE 52 of 60**: src/strategy_bollinger_squeeze_breakout.cpp
...
## 📄 **FILE 53 of 60**: src/strategy_market_making.cpp
...
StrategySignal MarketMakingStrategy::calculate_signal(const std::vector<Bar>& bars, int current_index) {
    ...
    std::cerr << "DEBUG: MarketMaking calculate_signal called with current_index=" << current_index << std::endl;
    std::cerr << "DEBUG: this=" << this << " rolling_returns_ win=" << rolling_returns_.win << std::endl;
    ...
    std::cerr << "DEBUG: About to calculate price_return" << std::endl;
    double price_return = (bars[current_index].close - bars[current_index - 1].close) / bars[current_index - 1].close;
    std::cerr << "DEBUG: price_return calculated: " << price_return << std::endl;
    std::cerr << "DEBUG: About to push to rolling_returns_" << std::endl;
    std::cerr << "DEBUG: rolling_returns_ win=" << rolling_returns_.win << " count=" << rolling_returns_.count << std::endl;
    rolling_returns_.push(price_return);
    std::cerr << "DEBUG: About to push to rolling_volume_" << std::endl;
    rolling_volume_.push(bars[current_index].volume);
    std::cerr << "DEBUG: Successfully pushed to rolling indicators" << std::endl;
...
bool MarketMakingStrategy::should_participate(const Bar& bar) {
    // Get current variance without pushing new data
    double volatility = 0.0;
    if (rolling_returns_.count > 0) {
        double mean = rolling_returns_.sum / rolling_returns_.count;
        double variance = std::max(0.0, (rolling_returns_.sumsq / rolling_returns_.count) - mean * mean);
    ...
    // Get current average volume without pushing new data
    double avg_volume = 0.0;
    if (rolling_volume_.count > 0) {
        avg_volume = rolling_volume_.sum / rolling_volume_.count;
    }
...
## 📄 **FILE 54 of 60**: src/strategy_momentum_volume.cpp
...
## 📄 **FILE 55 of 60**: src/strategy_opening_range_breakout.cpp
...
## 📄 **FILE 56 of 60**: src/strategy_order_flow_imbalance.cpp
...
## 📄 **FILE 57 of 60**: src/strategy_order_flow_scalping.cpp
...
## 📄 **FILE 58 of 60**: src/strategy_volatility_expansion.cpp
...
## 📄 **FILE 59 of 60**: src/strategy_vwap_reversion.cpp
